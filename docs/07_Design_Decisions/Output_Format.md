...
✏️ Optional: Future support for custom prefixes or extensions (`.cfg`, `.conf`)
...
- ⚠️ Configs should render correctly with or without optional fields
